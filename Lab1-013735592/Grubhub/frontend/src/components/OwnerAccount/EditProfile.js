        ...
        return (
            <div class="card-body">
                ...
                <form onSubmit={this.props.submitUpdate}>
                    ...
                    <div style={{ width: '30%' }} className="form-group">
                        <label>Phone</label>
                        <input type="tel" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" placeholder="e.g. 555-555-1212" class="form-control" value={this.props.phone} name="phone" onChange={this.props.phoneChangeHandler} />
                    </div>
                    <div style={{ width: '30%' }} className="form-group">
                        <label>Restaurant Name</label>
                        <input value={this.props.restName} type="text" class="form-control" name="email" onChange={this.props.restNameChangeHandler} />
                    </div>
                    <div style={{ width: '30%' }} className="form-group">
                        <label>Cuisine</label>
                        <input value={this.props.cuisine} type="text" class="form-control" name="email" onChange={this.props.cuisineChangeHandler} />
                    </div>
